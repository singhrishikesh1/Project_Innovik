...
// Initial active scenario: Chamoli Cloudburst & Alaknanda Flash Flood
...
export const evacuationRoutesData: EvacuationRoute[] = [
  {
    ...
    waypoints: [
      ...
      { lat: 30.4350, lng: 79.3450 }, // Critical point near Km 42
  ...
  },
  {
    ...
    waypoints: [
      { lat: 30.4590, lng: 79.3690 },
      { lat: 30.4610, lng: 79.3520 }, // Ridge bypass road (high altitude, safe from river surge)
  ...
  },
  {
    ...
    destinationCoords: { lat: 30.5560, lng: 79.5680 },
    waypoints: [
      { lat: 30.5480, lng: 79.5580 },
      { lat: 30.5510, lng: 79.5620 },
      { lat: 30.5560, lng: 79.5680 }
    ],
    distanceKm: 2.1,
...
export const emergencyTasksData: EmergencyTask[] = [
  ...
  {
    id: 'TASK-004',
    title: 'Continuous Water Level Monitoring at CWC Gauge Station 08-ALAK',
    priority: 'MEDIUM',
    locationName: 'CWC Hydro Station 08-ALAK',
    coords: { lat: 30.4110, lng: 79.3230 },
    assignedTeam: 'Central Water Commission Duty Engineers',
    requiredResources: 'Digital Hydro Sensor Calibrator',
    deadlineMinutes: 120,
    status: 'IN_PROGRESS',
    createdTime: '2026-09-15T06:30:00Z'
  }
];
...
export const dataSourcesStatusData: DataSourceStatus[] = [
  {
    id: 'DS-01',
    name: 'India Meteorological Department (IMD) Doppler Radar Network',
    type: 'RAINFALL_RADAR',
    status: 'ONLINE',
    lastUpdated: '1 minute ago',
    dataQuality: '99.4%',
    coverage: 'Uttarakhand State (Mussoorie, Surkanda Devi, Mukteshwar Radars)',
    isSimulated: false
  },
  {
    id: 'DS-02',
    name: 'Central Water Commission (CWC) Real-Time Hydrological Gauges',
    type: 'IOT_HYDRO',
    status: 'ONLINE',
    lastUpdated: 'Just now',
    dataQuality: '97.8%',
    coverage: 'Alaknanda, Mandakini, Bhagirathi & Ganga Basins',
    isSimulated: false
  },
  {
    id: 'DS-03',
    name: 'ESA Copernicus Sentinel-1 SAR & Sentinel-2 MSI Multi-Spectral',
    type: 'SATELLITE',
    status: 'ONLINE',
    lastUpdated: '4 hours ago (Last Overpass)',
    dataQuality: '99.4%',
    coverage: 'Himalayan Cryosphere & River Valleys (10m Resolution)',
    isSimulated: false
  },
  {
    id: 'DS-04',
    name: 'National Center for Seismology (NCS) Broadband Network',
    type: 'SEISMIC',
    status: 'ONLINE',
    lastUpdated: '30 seconds ago',
    dataQuality: '99.4%',
    coverage: 'Seismic Zone V (Garhwal & Kumaon Tectonic Faults)',
    isSimulated: false
  },
  {
    id: 'DS-05',
    name: 'ISRO Bhuvan Spatial Geoportal & Cadastral Layers',
    type: 'GIS_CADASTRAL',
    status: 'ONLINE',
    lastUpdated: 'Daily sync',
    dataQuality: '100% (LOCAL CACHE)',
    coverage: 'National Infrastructure, Road Networks & Village Boundaries',
    isSimulated: false
  }
];
...
export const initialPerformanceKPI: ResponsePerformanceKPI = {
  detectionTimeMin: 18,
  warningLeadTimeMin: 260, // 4.3 hours
